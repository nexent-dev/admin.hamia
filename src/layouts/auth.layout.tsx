    ...
    return (
        <div className="w-100 h-100 d-flex flex-column">
            <div className="flex-grow-1 d-flex auth-layout">
                <div className="auth-panel-left d-flex flex-column justify-content-center align-items-start px-4 px-md-5">
                ...
                <div className="auth-panel-right d-none d-md-flex align-items-center justify-content-center">
